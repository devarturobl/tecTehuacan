import 'package:dia3/screens/single_item_screen.dart';
          ...
          decoration: BoxDecoration(
            ...
            child: Column(
              ...
              children: [
                InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => SingleItemScreen(img[i]['name'], img[i]['description'], img[i]['price'], img[i]['volumen'])));
                  },
                  child: Container(
